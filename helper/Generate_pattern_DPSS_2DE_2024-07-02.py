...
parameters_E = [
    ...
    {'par': 1e-12, 'type': 'ptype', 'name': 'soma_dc_PI'},                              # parameter1<8>
    {'par': 6000e-12, 'type': 'ntype', 'name': 'soma_gain_NI'},                         # parameter1<9>
    ...
    {'par': 1000e-12, 'type': 'ntype', 'name': 'dyn_error_drive_NI'},                    # parameter1<28>
    {'par': 200e-12, 'type': 'ptype', 'name': 'dyninh_error_offset_up_PI'},                  # parameter1<29>
    {'par': 350e-12, 'type': 'ntype', 'name': 'dyninh_error_offset_down_NI'},                  # parameter1<30>
    {'par': 40e-12, 'type': 'ptype', 'name': 'dyninh_tau2_PI', 'reset': True},            # parameter1<31>
    {'par': 100e-12, 'type': 'ptype', 'name': 'dyninh_gain2_PI'},                         # parameter1<32>
    {'par': 40e-12, 'type': 'ptype', 'name': 'dynext_tau2_PI', 'reset': True},            # parameter1<33>
    {'par': 50e-12, 'type': 'ptype', 'name': 'dynext_gain2_PI'},                         # parameter1<34>
...
parameters_F = [
    ...
    {'par': 1000e-12, 'type': 'ntype', 'name': 'soma_refractory_NI'},                    # parameter1<6>
    {'par': 12e-12, 'type': 'ntype', 'name': 'soma_leak_NI', 'reset': True},            # parameter1<7>
]
...
parameters_config_0 = [                                             # mon_switch_x
        ...
        {'par': 1, 'name': 'post_dpi_x'},                       # conf4   mon 3
        {'par': 0, 'name': 'inh_dpi_x'},                        # conf5    mon 3
        {'par': 0, 'name': 'exc_dpi_x'},                        # conf6    mon 3
...
def create_SPI0_input(loop = 10):
    ...
    for parameter in list_of_parameters[::-1]:
            ...
            #parameter[22]["par"] = loop * 1e-12
            #parameter[18]["par"] = loop * 1e-12
