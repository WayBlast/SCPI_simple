...
def oj_200ms(regular=True,invert=False,disable_teacher=False):
    epochs= 4
    duration = 3000
    pre_rep = 1
    post_rep = 1
    ...
    pattern_o_30 = [1,2,3,5,9,10,14,15,19,20,24,26,27,28]
    pattern_j_30 = [1,2,3,5,9,14,19,24,29]
    pattern_l_30 = [0,1,2,3,5,10,15,20,25]
    pattern_I_30 = [2,7,12,17,22,27,16,18,3] # this pattern is actually a "t" shape with the last 3 elements.
    pattern__30 = []
